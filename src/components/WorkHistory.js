    ...
    <div className="history-div playball">Experience
      <div className="history-container">
        <ul className="history-ul">
          ...
          <li className="montserrat second">Full Stack Software Developer</li>
          ...
          <li className="montserrat mid last">Development skills gained include React.js, Angular.js, Typescript, Ruby On Rails, Node.js, Git, among others.</li>
        </ul>
        <ul className="history-ul playball">
          <li className="montserrat">Flight Centre</li>
          <li className="montserrat second">Technical Business Analyst</li>
          ...
          <li className="montserrat mid last">Independently researched, implemented, and delivered new technology (Booking Builder) to improve training program and support front-line employees</li>
        </ul>
        <ul className="history-ul">
          <li className="montserrat">FCM Travel Solutions</li>
          <li className="montserrat second">Team Leader</li>
          ...
          <li className="montserrat mid last">Oversaw in-office operations such as training new employees, launching new accounts, managing existing accounts, and following “one best way” policy in addition to daily duties</li>
        </ul>
        <ul className="history-ul">
          <li className="montserrat">Liberty Travel</li>
          <li className="montserrat second">Luxury Travel Consultant</li>
          ...
          <li className="montserrat mid last">Utilized multiple combinations of technologies to ensure the best value for my clients</li>
        </ul>
      </div>
    </div>
  )
